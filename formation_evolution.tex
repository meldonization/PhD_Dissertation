...
或者宽平台型（如 OGLE-LMC- ECL-17782，文献 \citen{Graczyk2011}）。如果探测到此类特殊结
...
这里，我们并没有考虑低信噪比、观测点太少的光变曲线，因为此类系统的在食部分并不能被有效地识别出。
...
食盘的概率应该不会大。与此同时，文献 \citen{Pawlak2013} 的研究显示该系统为前景视线方向上的晚型
...
文献 \citen{Derekas2007,Graczyk2011} 中提到 LMC 中 EBs 的色指数星等分布图具有双峰结构，分别为偏蓝
